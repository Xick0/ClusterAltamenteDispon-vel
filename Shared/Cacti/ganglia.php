...
// Ensure $SKIP_GMETAD_CONTEXTS is defined as an array
if (!isset($SKIP_GMETAD_CONTEXTS)) {
...
function Gmetad () {
   ...
   global $conf, $error, $parsetime, $clustername, $context, $hostname, $debug;
   ...
   if (isset($SKIP_GMETAD_CONTEXTS) && in_array($context, $SKIP_GMETAD_CONTEXTS)) {
      return TRUE;
   }
